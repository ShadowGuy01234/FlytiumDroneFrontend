      ...
      {isShowing && (
        <div className={`fixed z-50 ${positions[position]}`}>
          <motion.div
            ...
            animate="visible"
            exit="exit"
            className={`max-w-sm w-full ${currentType.bgColor} border rounded-lg shadow-medium p-4`}
            {...props}
          >
            <div className="flex items-start">
              ...
              <div className="ml-4 flex-shrink-0 flex">
                <button
                  className={`inline-flex ${currentType.textColor} hover:${currentType.textColor} focus:outline-none`}
                  onClick={() => {
                    setIsShowing(false);
